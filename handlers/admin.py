...
from Data_base.sqlite_db import db_start
from creat_bot import bot
from Keyboard.admin_kb import button_case_admin
...
#@dp.channel_post_hanlder(commands=['moderator'], is_chat_admin=True)
...
def register_handler_admin(dp: Dispatcher):
    dp.register_channel_post_handler(make_changes_commands, commands=['moderator'])
